...
# > The #send method inherits from the Object class. This tries to invoke the method represented by the first arguemnt, upon
# the other argument(s)

# > So in this example, we are calling the method PostalService.#street_address, which does not exist.
# 