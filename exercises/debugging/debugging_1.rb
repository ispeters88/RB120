...
# On line #42, `Book#display_data` instance method is called on the `books` instance variable.
# `Books` is an `Array` object, so this raises a NoMethodError exception.